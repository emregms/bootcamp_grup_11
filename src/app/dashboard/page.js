...
import {
  ...
  ArrowUpRight, ArrowDownLeft, Star, Users, MessageSquare,
  ChevronRight, Repeat, Sparkles, Video, Gift, Zap
} from 'lucide-react';
import { currentUser, creditHistory, upcomingLessons, matchSuggestions } from '@/data/mock';
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.sectionCard}>
              <div className={styles.sectionHeader}>
                ...
                <Link href="/chat" className={styles.seeAll}>Tümü <ChevronRight size={14} /></Link>
              </div>
          ...
          <div className={styles.rightCol}>
            ...
            <div className={styles.sectionCard}>
              ...
              <Link href="/match" className={`btn btn-ghost w-full ${styles.matchAllBtn}`}>
                Tüm Eşleşmeleri Gör <ArrowUpRight size={14} />
              </Link>
            </div>
